...
def retrieve_remind_data(code_entry):
    try:
        ...
        select_query = '''SELECT mdiname, fdose, sdose, tdose, fodose 
                          FROM remind 
...
tree = ttk.Treeview(dashboard_window, columns=("medname", "1st dose", "2nd dose", "3rd dose", "4th dose"), show="headings")
...
# Set column widths
tree.column("medname", width=200)
tree.column("1st dose", width=150)
tree.column("2nd dose", width=150)
tree.column("3rd dose", width=150)
tree.column("4th dose", width=150)
