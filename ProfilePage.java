...
public class ProfilePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        save_bttn.setBackground(new java.awt.Color(172, 82, 50));
        save_bttn.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        save_bttn.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void save_bttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_bttnActionPerformed
        ...
        String library_card_no = jTextField3.getText();
        int lcn = Integer.parseInt(library_card_no);
        ...
        String brnch = "";
        if(branch.equals("AIDS")){
            brnch = "AIDS";
        }
        if(branch.equals("AU&RO")){
            brnch = "AU&RO";
        }
        if(branch.equals("ECS")){
            brnch = "ECS";
        }
        if(branch.equals("EXTC")){
            brnch = "EXTC";
        }
        if(branch.equals("INFT")){
            brnch = "INFT";
        }
        ...
        String div = jTextField7.getText();
        String mobile_no = jTextField9.getText();
        ...
        try {
           ...
           stat.setString(7, branch);
           stat.setString(8, div);
           stat.setString(9, mobile_no);
